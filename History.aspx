...
<body>
    <form id="form1" runat="server">
        ...
        <center>
            ...
            <h2 style="background-color: teal; color: white; border: 2px solid black; border-radius: 10px"><i><b>HISTORY BOOKS</b></i></h2>
            <div class="all-products">
                <div class="product">
                    <asp:Image ID="bs1" runat="server" ImageUrl="~/images/History1.jpg" />
                    <div class="product-info">
                        <h4 class="product-title">
                            <asp:Label ID="lbl1" runat="server" Text="India's Ancient Past <br>
R.S Sharma"></asp:Label>
                        </h4>
                        <p class="product-price">
                            <asp:Label ID="lbl2" runat="server" Text="₹320"></asp:Label>
                        </p>
                ...
                <div class="product">
                    <asp:Image ID="bs2" runat="server" ImageUrl="~/images/History2.jpg" />
                    <div class="product-info">
                        <h4 class="product-title">
                            <asp:Label ID="lbl3" runat="server" Text="Incredible History of Indian Geography <br>
Sanjeev Sanyal"></asp:Label>
                        </h4>
                        <p class="product-price">
                ...
                <div class="product">
                    <asp:Image ID="bs3" runat="server" ImageUrl="~/images/History3.jpg" />
                    <div class="product-info">
                        <h4 class="product-title">
                            <asp:Label ID="lbl5" runat="server" Text="Young Heroes and other Stalwarts of the Freedom Struggle <br>
Reena Puri"></asp:Label>
                        </h4>
                        <p class="product-price">
                            <asp:Label ID="lbl6" runat="server" Text="₹50"></asp:Label>
                        </p>
                        <a class="product-btn" href="#">
                ...
                <div class="product">
                    <asp:Image ID="bs4" runat="server" ImageUrl="~/images/History4.jpg" />
                    <div class="product-info">
                        <h4 class="product-title">
                            <asp:Label ID="lbl7" runat="server" Text="Courting India <br>
Nandini Das"></asp:Label>
                        </h4>
                        <p class="product-price">
                            <asp:Label ID="lbl8" runat="server" Text="₹450"></asp:Label>
                        </p>
                        <a class="product-btn" href="#">
            ...
            <div class="all-products">
                <div class="product">
                    <asp:Image ID="Image1" runat="server" ImageUrl="~/images/History5.jpg" />
                    <div class="product-info">
                        <h4 class="product-title">
G.B.S Sindhu"></asp:Label>
                        </h4>
                        <p class="product-price">
                            <asp:Label ID="Label2" runat="server" Text="₹320"></asp:Label>
                        </p>
                        <a class="product-btn" href="#">
                ...
                <div class="product">
                    <asp:Image ID="Image2" runat="server" ImageUrl="~/images/History6.jpg" />
                    <div class="product-info">
                        <h4 class="product-title">
                            <asp:Label ID="Label3" runat="server" Text="The Pashtuns <br>
Tilak Devasher"></asp:Label>
                        </h4>
                        <p class="product-price">
                            <asp:Label ID="Label4" runat="server" Text="₹520"></asp:Label>
                        </p>
                        <a class="product-btn" href="#">
                ...
                <div class="product">
                    <asp:Image ID="Image3" runat="server" ImageUrl="~/images/History7.jpg" />
                    <div class="product-info">
                        <h4 class="product-title">
                            <asp:Label ID="Label5" runat="server" Text="Ahoms <br>
Arup Kumar Datta"></asp:Label>
                        </h4>
                        <p class="product-price">
                ...
                <div class="product">
                    <asp:Image ID="Image4" runat="server" ImageUrl="~/images/History8.jpg" />
                    <div class="product-info">
                        <h4 class="product-title">
                            <asp:Label ID="Label7" runat="server" Text="The Earth Transformed <br>
Peter Frankopan"></asp:Label>
                        </h4>
                        <p class="product-price">
                            <asp:Label ID="Label8" runat="server" Text="₹580"></asp:Label>
                        </p>
                        <a class="product-btn" href="#">
            ...
            <div class="all-products">
                <div class="product">
                    <asp:Image ID="Image5" runat="server" ImageUrl="~/images/History9.jpg" />
                    <div class="product-info">
                        <h4 class="product-title">
                            <asp:Label ID="Label9" runat="server" Text="History of India <br>
R.C Majumdar"></asp:Label>
                        </h4>
                        <p class="product-price">
                            <asp:Label ID="Label10" runat="server" Text="₹630"></asp:Label>
                        </p>
                        <a class="product-btn" href="#">
                ...
                <div class="product">
                    <asp:Image ID="Image6" runat="server" ImageUrl="~/images/History10.jpg" />
                    <div class="product-info">
                        <h4 class="product-title">
                            <asp:Label ID="Label11" runat="server" Text="Bharat ka Itihas <br>
Yogendra Prasad"></asp:Label>
                        </h4>
                        <p class="product-price">
                            <asp:Label ID="Label12" runat="server" Text="₹310"></asp:Label>
                        </p>
                        <a class="product-btn" href="#">
                ...
                <div class="product">
                    <asp:Image ID="Image7" runat="server" ImageUrl="~/images/History11.jpg" />
                    <div class="product-info">
                        <h4 class="product-title">
                            <asp:Label ID="Label13" runat="server" Text="The History of Indian Art <br>
Anil Rao Sandhya Ketkar"></asp:Label>
                        </h4>
                        <p class="product-price">
                ...
                <div class="product">
                    <asp:Image ID="Image8" runat="server" ImageUrl="~/images/History12.jpg" />
                    <div class="product-info">
                        <h4 class="product-title">
                            <asp:Label ID="Label15" runat="server" Text="What Happened to Netaji  <br>
Anuj Dhar"></asp:Label>
                        </h4>
                        <p class="product-price">
                            <asp:Label ID="Label16" runat="server" Text="₹340"></asp:Label>
                        </p>
                        <a class="product-btn" href="#">
            ...
            <div class="all-products">
                <div class="product">
                    <asp:Image ID="Image9" runat="server" ImageUrl="~/images/History13.jpg" />
                    <div class="product-info">
                        <h4 class="product-title">
                            <asp:Label ID="Label17" runat="server" Text="Indus Basin Uninterupted <br>
Uttam Kumar Sinha"></asp:Label>
                        </h4>
                        <p class="product-price">
                            <asp:Label ID="Label18" runat="server" Text="₹620"></asp:Label>
                        </p>
                        <a class="product-btn" href="#">
                ...
                <div class="product">
                    <asp:Image ID="Image10" runat="server" ImageUrl="~/images/History14.jpg" />
                    <div class="product-info">
                        <h4 class="product-title">
                            <asp:Label ID="Label19" runat="server" Text="1946 War of Independence  <br>
Pramod Kapoor"></asp:Label>
                        </h4>
                        <p class="product-price">
                            <asp:Label ID="Label20" runat="server" Text="₹450"></asp:Label>
                        </p>
                        <a class="product-btn" href="#">
                ...
                <div class="product">
                    <asp:Image ID="Image11" runat="server" ImageUrl="~/images/History15.jpg" />
                    <div class="product-info">
                        <h4 class="product-title">
                            <asp:Label ID="Label21" runat="server" Text="Bharat ka Samvidhan <br>
Subhash Kashyap"></asp:Label>
                        </h4>
                        <p class="product-price">
                            <asp:Label ID="Label22" runat="server" Text="₹120"></asp:Label>
                        </p>
                        <a class="product-btn" href="#">
                ...
                <div class="product">
                    <asp:Image ID="Image12" runat="server" ImageUrl="~/images/History16.jpg" />
                    <div class="product-info">
                        <h4 class="product-title">
                            <asp:Label ID="Label23" runat="server" Text="Philosophy of Rabindranath Tagore <br>
Sarvepalli Radhakrishnan"></asp:Label>
                        </h4>
                        <p class="product-price">
