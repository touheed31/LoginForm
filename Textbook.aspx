...
<body>
    <form id="form1" runat="server">
        ...
        <center>
            ...
            <h2 style="background-color: teal; color: white; border: 2px solid black; border-radius: 10px"><i><b>TEXTBOOKS</b></i></h2>
            <div class="all-products">
                <div class="product">
                    <asp:Image ID="t1" runat="server" ImageUrl="~/images/Textbook1.jpg" />
                    <div class="product-info">
                        <h4 class="product-title">
                            <asp:Label ID="lbl1" runat="server" Text="Medical Physiology &lt;br&gt;
John.E.Hall"></asp:Label>
                        </h4>
                        <p class="product-price">
                            <asp:Label ID="lbl2" runat="server" Text="₹1750"></asp:Label>
                        </p>
                ...
                <div class="product">
                    <asp:Image ID=t2" runat="server" ImageUrl="~/images/Textbook2.jpg" />
                    <div class="product-info">
                        <h4 class="product-title">
                            <asp:Label ID="lbl3" runat="server" Text="Biochemistry &lt;br&gt;
Vasudevan"></asp:Label>
                        </h4>
                        <p class="product-price">
                            <asp:Label ID="lbl4" runat="server" Text="₹1370"></asp:Label>
                        </p>
                        <a class="product-btn" href="#">
                ...
                <div class="product">
                    <asp:Image ID="t3" runat="server" ImageUrl="~/images/Textbook3.jpg" />
                    <div class="product-info">
                        <h4 class="product-title">
                            <asp:Label ID="lbl5" runat="server" Text="NCERT Chemistry Class12&lt;br&gt;
MTG Editoraal  Board"></asp:Label>
                        </h4>
                        <p class="product-price">
                            <asp:Label ID="lbl6" runat="server" Text="₹300"></asp:Label>
                        </p>
                        <a class="product-btn" href="#">
                ...
                <div class="product">
                    <asp:Image ID="t4" runat="server" ImageUrl="~/images/Textbook4.jpg" />
                    <div class="product-info">
                        <h4 class="product-title">
                            <asp:Label ID="lbl7" runat="server" Text="NCERT Chemistry Class12&lt;br&gt;MTG Editoraal  Board"></asp:Label>
                        </h4>
                        <p class="product-price">
            ...
            <div class="all-products">
                <div class="product">
                    <asp:Image ID="t5" runat="server" ImageUrl="~/images/Textbook5.jpg" />
                    <div class="product-info">
                        <h4 class="product-title">
                            <asp:Label ID="Label1" runat="server" Text="Medical Surgical Nursing &lt;br&gt;
Walters"></asp:Label>
                        </h4>
                        <p class="product-price">
                            <asp:Label ID="Label2" runat="server" Text="₹2010"></asp:Label>
                        </p>
                        <a class="product-btn" href="#">
                ...
                <div class="product">
                    <asp:Image ID="t6" runat="server" ImageUrl="~/images/Textbook6.jpg" />
                    <div class="product-info">
                        <h4 class="product-title">
                            <asp:Label ID="Label3" runat="server" Text="NCERT Physics Class12&lt;br&gt;MTG Editoraal  Board"></asp:Label>
                        </h4>
                        <p class="product-price">
                            <asp:Label ID="Label4" runat="server" Text="₹240"></asp:Label>
                        </p>
                        <a class="product-btn" href="#">
                ...
                <div class="product">
                    <asp:Image ID="t7" runat="server" ImageUrl="~/images/Textbook7.jpg" />
                    <div class="product-info">
                        <h4 class="product-title">
                            <asp:Label ID="Label5" runat="server" Text="NCERT Physics Class11&lt;br&gt;MTG Editoraal  Board"></asp:Label>
                        </h4>
                        <p class="product-price">
                            <asp:Label ID="Label6" runat="server" Text="₹230"></asp:Label>
                        </p>
                        <a class="product-btn" href="#">
                ...
                <div class="product">
                    <asp:Image ID="t8" runat="server" ImageUrl="~/images/Textbook8.jpg" />
                    <div class="product-info">
                        <h4 class="product-title">
                            <asp:Label ID="Label7" runat="server" Text="Social Science &lt;br&gt;
Digraj Singh Rajput"></asp:Label>
                        </h4>
                        <p class="product-price">
                            <asp:Label ID="Label8" runat="server" Text="₹810"></asp:Label>
                        </p>
                        <a class="product-btn" href="#">
            ...
            <div class="all-products">
                <div class="product">
                    <asp:Image ID="t9" runat="server" ImageUrl="~/images/Textbook9.jpg" />
                    <div class="product-info">
                        <h4 class="product-title">
                            <asp:Label ID="Label9" runat="server" Text="NCERT Mathematics Class11&lt;br&gt;MTG Editoraal  Board"></asp:Label>
                        </h4>
                        <p class="product-price">
                ...
                <div class="product">
                    <asp:Image ID="t10" runat="server" ImageUrl="~/images/Textbook10.jpg" />
                    <div class="product-info">
                        <h4 class="product-title">
                            <asp:Label ID="Label11" runat="server" Text="NCERT Mathematics Class11&lt;br&gt;MTG Editoraal  Board"></asp:Label>
                        </h4>
                        <p class="product-price">
                            <asp:Label ID="Label12" runat="server" Text="₹220"></asp:Label>
                        </p>
                        <a class="product-btn" href="#">
                ...
                <div class="product">
                    <asp:Image ID="t11" runat="server" ImageUrl="~/images/Textbook11.jpg" />
                    <div class="product-info">
                        <h4 class="product-title">
                            <asp:Label ID="Label13" runat="server" Text="Examcart Competitive Reasoning Shortcut &lt;br&gt; Examcart Experts"></asp:Label>
                        </h4>
                        <p class="product-price">
                            <asp:Label ID="Label14" runat="server" Text="₹320"></asp:Label>
                        </p>
                        <a class="product-btn" href="#">
                ...
                <div class="product">
                    <asp:Image ID="t12" runat="server" ImageUrl="~/images/Textbook12.jpg" />
                    <div class="product-info">
                        <h4 class="product-title">
                            <asp:Label ID="Label15" runat="server" Text="Introductory Macroeconomics&lt;br&gt;
NCERT"></asp:Label>
                        </h4>
                        <p class="product-price">
                            <asp:Label ID="Label16" runat="server" Text="₹150"></asp:Label>
                        </p>
                        <a class="product-btn" href="#">
            ...
            <div class="all-products">
                <div class="product">
                    <asp:Image ID="t13" runat="server" ImageUrl="~/images/Textbook13.jpg" />
                    <div class="product-info">
                        <h4 class="product-title">
                            <asp:Label ID="Label17" runat="server" Text="Community Health Nursing  &lt;br&gt;
S.D. Manivannan"></asp:Label>
                        </h4>
                        <p class="product-price">
                            <asp:Label ID="Label18" runat="server" Text="₹400"></asp:Label>
                        </p>
                        <a class="product-btn" href="#">
                ...
                <div class="product">
                    <asp:Image ID="t14" runat="server" ImageUrl="~/images/Textbook14.jpg" />
                    <div class="product-info">
                        <h4 class="product-title">
                            <asp:Label ID="Label19" runat="server" Text="Physical Education &lt;br&gt;
Dr.DS Yadav"></asp:Label>
                        </h4>
                        <p class="product-price">
                            <asp:Label ID="Label20" runat="server" Text="₹460"></asp:Label>
                        </p>
                        <a class="product-btn" href="#">
                ...
                <div class="product">
                    <asp:Image ID="t15" runat="server" ImageUrl="~/images/Textbook15.jpg" />
                    <div class="product-info">
                        <h4 class="product-title">
                            <asp:Label ID="Label21" runat="server" Text="Oral Pathology&lt;br&gt;
Dr.Sivapathasundharam"></asp:Label>
                        </h4>
                        <p class="product-price">
                            <asp:Label ID="Label22" runat="server" Text="₹1820"></asp:Label>
                        </p>
                        <a class="product-btn" href="#">
                ...
                <div class="product">
                    <asp:Image ID="" runat="server" ImageUrl="~/images/Textbook16.jpg" />
                    <div class="product-info">
                        <h4 class="product-title">
                            <asp:Label ID="Label23" runat="server" Text="Contempory India &lt;br&gt;
National Council of India"></asp:Label>
                        </h4>
                        <p class="product-price">
                            <asp:Label ID="Label24" runat="server" Text="₹140"></asp:Label>
                        </p>
                        <a class="product-btn" href="#">
